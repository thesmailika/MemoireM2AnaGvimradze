...
\supervisor{Lom Messan \textsc{Hillah}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\text{\Medium 8 Juillet, 2019 }\\[0.5cm] % date en dur
